...
QT_MOC_LITERAL(1, 10, 16), // "lineChartClicked"
QT_MOC_LITERAL(2, 27, 0) // ""

    },
    "ChartView\0lineChartClicked\0"
};
...
void ChartView::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->lineChartClicked((*reinterpret_cast< QPointF(*)>(_a[1]))); break;
        default: ;
        }
        ...
        {
            typedef void (ChartView::*_t)(QPointF );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&ChartView::lineChartClicked)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void ChartView::lineChartClicked(QPointF _t1)
{
